...
**Repository**: https://github.com/ProgramingLanguageStudy/Project-Starfall
...
| 단계 | 상태 | 설명 |
|------|------|------|
| **Phase 1: Core Systems** | ✅ 완료 | 분대/전투/세이브/퀘스트/대화 등 핵심 시스템 구축 및 기술 검증 |
| **Phase 2: Content Loop** | 🚧 진행 중 | 플레이 가능한 성장-보상 루프 구축 (골드, 장비, 스킬 등) |
...
<tr>
<td><strong>제단 레벨업</strong><br><img src="Docs/images/altar-levelup.png" width="400" alt="제단 레벨업"></td>
...
### 5.1 Short-term (1-2주) - Phase 2
| 우선순위 | 항목 | 목적 |
|:--------:|------|------|
| 1 | 퀘스트 목록 창 | 수락/진행/완료 퀘스트 전체 관리 |
| 2 | 캐릭터 상태창 | 레벨/스탯/장비 확인용 종합 UI |
| 3 | 레벨업 UI 마무리 | 제단(Altar) 뷰 완성 및 메시지 처리 |

### 5.2 Mid-term (1-2개월) - Phase 2 심화
| 우선순위 | 항목 | 목적 |
|:--------:|------|------|
| 1 | 장비 착용/해제 시스템 | EquipmentItemData 활용한 성장 요소 |
| 2 | 캐릭터 대시 | 전투 쾌감 및 기동성 |
| 3 | 스킬 시스템 + 쿨다운 UI | 전투 전략성 추가 |
...
| **AI Assistant** | Trae IDE, Cursor IDE |

**주요 Unity 패키지**

| 패키지 | 목적 |
|--------------|------|
| **Addressables** | 원격 콘텐츠 관리 및 메모리 최적화를 위한 비동기 에셋 시스템 |
| **AI Navigation** | NavMesh 기반의 지능형 길찾기 및 동적 장애물 회피 구현 |
| **Input System** | 다양한 입력 장치(키보드, 마우스, 게임패드)를 일관된 방식으로 처리 |
| **Universal RP** | 모바일과 PC를 아우르는 고성능 렌더링 파이프라인 |
